...
set read_ulay    = "epi.ulay.r03+orig.HEAD"  
set read_olay    = "radcor.20.r03.corr+orig.HEAD"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_20_radcor_rc_tcat_r03.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
...
set impref       = "qc_20_radcor_rc_tcat_r03"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_20_radcor_rc_tcat_r03.pbar.jpg dim=64x512H"                                             \
