...
set read_ulay    = "anat_final.sub-002+tlrc.HEAD"  
set read_olay    = "MNI152_2009_template_SSW.nii.gz"  
set read_dir     = "."  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "+"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_04_va2t_anat2temp.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1332.439765"  
set frange       = "1059.000000"  
set thrnew       = "0"  
set thrflag      = "*"  
set olay_alpha   = "No"  
set olay_boxed   = "No"  
...
set impref       = "qc_04_va2t_anat2temp"  
set bufac        = "1"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_04_va2t_anat2temp.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1332.439765"                                             \
    -com "SET_FUNC_RANGE  1059.000000"                                 \
    -com "SET_THRESHNEW   0 *"                          \
