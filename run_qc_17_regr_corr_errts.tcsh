...
set read_olay    = "corr_brain+tlrc.HEAD"  
set read_dir     = "."  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "-"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_17_regr_corr_errts.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
...
set impref       = "qc_17_regr_corr_errts"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_17_regr_corr_errts.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1296.724320"                                             \
    -com "SET_FUNC_RANGE  0.6"                                 \
    -com "SET_THRESHNEW   0.3 *"                          \
