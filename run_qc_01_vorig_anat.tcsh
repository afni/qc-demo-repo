...
set read_ulay    = "anatSS.sub-002+orig.HEAD"  
set read_olay    = "anatSS.sub-002+orig.HEAD"  
set read_dir     = "."  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "+"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_01_vorig_anat.pbar.jpg dim=64x512H"  
set subbb        = ( -1 -1 -1 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0 1067.382568"  
set frange       = "1067.382568"  
set thrnew       = "0"  
set thrflag      = "*"  
set olay_alpha   = "No"  
set olay_boxed   = "No"  
...
set coors        = ( -2 -3.9133 13.6803 )  
set ftype        = "JPEG"  
set odir         = "QC_sub-002/media"  
set impref       = "qc_01_vorig_anat"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_01_vorig_anat.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   -1 -1 -1"                                  \
    -com "SET_ULAY_RANGE A.all 0 1067.382568"                                             \
    -com "SET_FUNC_RANGE  1067.382568"                                 \
    -com "SET_THRESHNEW   0 *"                          \
    ...
    -com "SET_XHAIR_GAP   -1"                                 \
    -com "SET_DICOM_XYZ -2 -3.9133 13.6803"                                         \
    ${view_planes:q}                                                 \
    ${read_dir} &
