...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_07_vstat_vis_0_Coef.pbar.jpg dim=64x512H"  
set subbb        = ( 0 1 2 )
...
set impref       = "qc_07_vstat_vis_0_Coef"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_07_vstat_vis_0_Coef.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 1 2"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1296.724320"                                             \
    -com "SET_FUNC_RANGE  3.932753"                                 \
