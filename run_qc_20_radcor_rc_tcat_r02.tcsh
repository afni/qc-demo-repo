...
set read_ulay    = "epi.ulay.r02+orig.HEAD"  
set read_olay    = "radcor.20.r02.corr+orig.HEAD"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_20_radcor_rc_tcat_r02.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1986.718800"  
set frange       = "0.7"  
set thrnew       = "0.4"  
set thrflag      = "*"  
set olay_alpha   = "Yes"  
...
set coors        = ( -2.662201 -12.7787 30.34942 )  
set ftype        = "JPEG"  
set odir         = "QC_sub-002/media"  
set impref       = "qc_20_radcor_rc_tcat_r02"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_20_radcor_rc_tcat_r02.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1986.718800"                                             \
    ...
    -com "SET_XHAIR_GAP   -1"                                 \
    -com "SET_DICOM_XYZ -2.662201 -12.7787 30.34942"                                         \
    ${view_planes:q}                                                 \
    ${read_dir} &

set l = `prompt_popup -message \
"APQC, radcor: rc_tcat_r02\n\n\
\n\n\
