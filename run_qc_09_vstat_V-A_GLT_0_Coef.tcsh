...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_09_vstat_V-A_GLT_0_Coef.pbar.jpg dim=64x512H"  
set subbb        = ( 0 7 8 )
...
set impref       = "qc_09_vstat_V-A_GLT_0_Coef"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_09_vstat_V-A_GLT_0_Coef.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 7 8"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1296.724320"                                             \
    -com "SET_FUNC_RANGE  2.597378"                                 \
