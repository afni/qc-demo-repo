...
set read_olay    = "mask_epi_anat.sub-002+tlrc.HEAD"  
set read_dir     = "."  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "-"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_05_va2t_mask2final.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
...
set impref       = "qc_05_va2t_mask2final"  
set bufac        = "1"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_05_va2t_mask2final.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1296.724320"                                             \
    -com "SET_FUNC_RANGE  1"                                 \
    -com "SET_THRESHNEW   0 *"                          \
