...
set read_ulay    = "vr_base_min_outlier_ts_ns+orig.HEAD"  
set read_olay    = "anatSS.sub-002_flip_al_junk+orig.HEAD"  
set read_dir     = "."  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "+"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_28_warns_flip_1.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 2142.840000"  
set frange       = "1113.827881"  
set thrnew       = "0"  
set thrflag      = "*"  
set olay_alpha   = "No"  
set olay_boxed   = "No"  
...
set coors        = ( -2.662201 -1.778702 30.34942 )  
set ftype        = "JPEG"  
set odir         = "QC_sub-002/media"  
set impref       = "qc_28_warns_flip_1"  
set bufac        = "1"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_28_warns_flip_1.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 2142.840000"                                             \
    -com "SET_FUNC_RANGE  1113.827881"                                 \
    -com "SET_THRESHNEW   0 *"                          \
    ...
    -com "SET_XHAIR_GAP   -1"                                 \
    -com "SET_DICOM_XYZ -2.662201 -1.778702 30.34942"                                         \
    ${view_planes:q}                                                 \
    ${read_dir} &
