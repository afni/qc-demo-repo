...
set read_ulay    = "epi.ulay.r03+tlrc.HEAD"  
set read_olay    = "radcor.20.r03.corr+tlrc.HEAD"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_21_radcor_rc_volreg_r03.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1879.269284"  
set frange       = "0.7"  
set thrnew       = "0.4"  
set thrflag      = "*"  
set olay_alpha   = "Yes"  
...
set impref       = "qc_21_radcor_rc_volreg_r03"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_21_radcor_rc_volreg_r03.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1879.269284"                                             \
