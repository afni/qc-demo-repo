...
set read_ulay    = "epi.ulay.r01+tlrc.HEAD"  
set read_olay    = "radcor.20.r01.corr+tlrc.HEAD"  
set read_dir     = ". radcor.pb02.volreg"  
set crossh       = "SINGLE"  
set see_olay     = "+"  
set pbar_sign    = "-"  
set ncolors      = "99"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_21_radcor_rc_volreg_r01.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1872.487374"  
set frange       = "0.7"  
set thrnew       = "0.4"  
set thrflag      = "*"  
set olay_alpha   = "Yes"  
...
set coors        = ( 2.5 9.25 23 )  
set ftype        = "JPEG"  
set odir         = "QC_sub-002/media"  
set impref       = "qc_21_radcor_rc_volreg_r01"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_21_radcor_rc_volreg_r01.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1872.487374"                                             \
    ...
    -com "SET_XHAIR_GAP   -1"                                 \
    -com "SET_DICOM_XYZ 2.5 9.25 23"                                         \
    ${view_planes:q}                                                 \
    ${read_dir} &

set l = `prompt_popup -message \
"APQC, radcor: rc_volreg_r01\n\n\
\n\n\
