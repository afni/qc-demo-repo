...
set my_cbar      = "Plasma"  
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-002/media/qc_06_vstat_Full_Fstat.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1296.724320"  
set frange       = "250.331573"  
set thrnew       = "23.645947"  
set thrflag      = "*"  
set olay_alpha   = "Yes"  
set olay_boxed   = "Yes"  
set func_resam   = "NN"  
...
set impref       = "qc_06_vstat_Full_Fstat"  
set bufac        = "2"  
set do_quit      = "QUITT"  
...
afni -q -no1D  -noplugins -no_detach  -echo_edu          \
    ...
    -com "PBAR_SAVEIM QC_sub-002/media/qc_06_vstat_Full_Fstat.pbar.jpg dim=64x512H"                                             \
    -com "SET_SUBBRICKS   0 0 0"                                  \
    -com "SET_ULAY_RANGE A.all 0.000000 1296.724320"                                             \
    -com "SET_FUNC_RANGE  250.331573"                                 \
    -com "SET_THRESHNEW   23.645947 *"                          \
